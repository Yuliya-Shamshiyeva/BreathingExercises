...
//        }
        ...
        val start_deep_breathing = view1.findViewById<FrameLayout>(R.id.deep_breathing) as FrameLayout
        start_deep_breathing.setOnClickListener(){
            try {
                startActivity(Intent(this@Menu, Practic_Vdox::class.java))
                finish()
            } catch (e: Exception) {
            } //конец конструкции чтобы не вылетало
        }
        ...
        val start_box_breathing = view1.findViewById<FrameLayout>(R.id.box_breathing) as FrameLayout
        start_box_breathing.setOnClickListener(){
            try {
                startActivity(Intent(this@Menu, Practic1::class.java))
                finish()
            } catch (e: Exception) {
        ...
        val start_breathing_478 = view1.findViewById<FrameLayout>(R.id.breathing_478) as FrameLayout
        start_breathing_478.setOnClickListener(){
            try {
                startActivity(Intent(this@Menu, Practic2::class.java))
                finish()
            } catch (e: Exception) {

...
class Practic_Vdox  : AppCompatActivity() {
    private var textCount = 0
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            setContentView(R.layout.practic_for_video_vdox)
...
//видео
            ...
            buttonStart.setOnClickListener {
                ...
                videoView.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.flower_new))
                //Зациклили видео
...
//
            ...
            buttonBack.setOnClickListener(){
                try {
                    startActivity(Intent(this@Practic_Vdox, Menu::class.java))
                    finish()
                } catch (e: Exception) {
                } //конец конструкции чтобы не вылетало
            }
